# Project Zomboid Codebase Analysis - AGENTS.md

**THIS FILE IS INTENDED TO BE READ BY Codex ONLY**  
...
## Directory Structure
- **claudeDocs/**: Technical analysis documents created by Codex
...
- **Codex Documents**: Always place in `claudeDocs/` directory with `claude_` prefix (e.g., `claude_fertilizerAnalysis.md`)
- **Document Modifications**: Only modify cursorDocs files to add "Codex Review" sections
...
- **cursorDocs/**: Read access + ability to add "Codex Review" sections only
...
- **Document ownership**: claudeDocs contains Codex-authored analyses, cursorDocs contains Cursor-authored analyses
...
## Review Process
- Peer review between Codex and Cursor for accuracy

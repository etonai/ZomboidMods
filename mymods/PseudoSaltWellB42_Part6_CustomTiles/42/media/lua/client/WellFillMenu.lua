...
function WellFillMenu.createMenu(player, context, worldobjects, test)
    ...
    if #emptyPots > 0 then
        ...
        local fillPotOption = context:addOption("Fill Pot with Saltwater", worldobjects, nil);
    ...
    if #emptyKettles > 0 then
        ...
        local fillKettleOption = context:addOption("Fill Kettle with Saltwater", worldobjects, nil);

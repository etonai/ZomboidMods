...
10. **Clean up** — cycle time raised from the 1-minute test duration used while implementing Steps 5-7. **Revised 2026-09-13 (direct instruction from Ed): target is 10 minutes of game time, not the 15 minutes originally stated above.** See `doc/planning/DevCycle010.md`.

...
--** SimpleWellMenu.lua
--***********************************************************
--** Adds "Dig Well" context menu option to ground
--***********************************************************
...
function SimpleWellMenu.onDigWell(worldobjects, shovel, player)
    ...
    -- Create the well building object with temporary grave sprite
    local well = ISSimpleWell:new("location_community_cemetary_01_33", shovel);
    well.player = player;

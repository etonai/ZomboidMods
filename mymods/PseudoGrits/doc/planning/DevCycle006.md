...
- [x] Launch Project Zomboid B42 with PseudoGrits enabled and confirm no script parse errors.
- [x] Confirm neutral bowl, pan, and pot grits craft entries appear.
- [x] Confirm separate sweet/savory craft entries do not appear at the initial craft step.
- [x] Confirm sweet grits can be created from neutral grits when oatmeal-style ingredients are available.
- [x] Confirm savory grits can be created from neutral grits when stew-style ingredients are available.
...
- [x] Confirm context menu labels show Sweet Grits and Savory Grits rather than raw translation keys.
